...
class GalaxyCatalogue:
    ...
    def __init__(self, catalogue_file, is_box=False, box_length=1500.0, randoms=False, boss_like=True,
                pos_cols=np.array([0, 1, 2]), omega_m=0.31, h=0.6777, verbose=True):
